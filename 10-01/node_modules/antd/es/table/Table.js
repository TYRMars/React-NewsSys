...
var Table = function (_React$Component) {
    ...
    function Table(props) {
        ...
        _this.handleFilter = function (column, nextFilters) {
            ...
            var pagination = assign({}, _this.state.pagination);
            var filters = assign({}, _this.state.filters, _defineProperty({}, _this.getColumnKey(column), nextFilters));
            ...
            var filtersToSetState = assign({}, filters);
            ...
            _this.setState(newState, function () {
                ...
                if (onChange) {
                    onChange.apply(null, _this.prepareParamsArguments(assign({}, _this.state, {
                        selectionDirty: false,
                        filters: filters,
                        pagination: pagination
                    })));
        ...
        _this.handleShowSizeChange = function (current, pageSize) {
            ...
            var nextPagination = assign({}, pagination, { pageSize: pageSize, current: current });
        ...
        _this.state = assign({}, _this.getSortStateFromColumns(), {
            // 减少状态
    ...
    _createClass(Table, [{
        ...
        value: function getDefaultPagination(props) {
            ...
            return this.hasPagination(props) ? assign({}, defaultPagination, pagination, {
        ...
        value: function componentWillReceiveProps(nextProps) {
            ...
            if ('pagination' in nextProps || 'pagination' in this.props) {
                this.setState(function (previousState) {
                    var newPagination = assign({}, defaultPagination, previousState.pagination, nextProps.pagination);
            ...
            if (filteredValueColumns.length > 0) {
                ...
                var newFilters = assign({}, this.state.filters);
        ...
        value: function renderColumnsDropdown(columns) {
            ...
            return treeMap(columns, function (originColumn, i) {
                var column = assign({}, originColumn);
        ...
        value: function renderPagination() {
            ...
            return total > 0 ? React.createElement(Pagination, _extends({ key: 'pagination' }, pagination, { className: this.props.prefixCls + '-pagination', onChange: this.handlePageChange, total: total, size: size, current: this.getMaxCurrent(total), onShowSizeChange: this.handleShowSizeChange })) : null;
        }
        ...
        value: function recursiveSort(data, sorterFn) {
            ...
            return data.sort(sorterFn).map(function (item) {
                return item[childrenColumnName] ? assign({}, item, _defineProperty({}, childrenColumnName, _this9.recursiveSort(item[childrenColumnName], sorterFn))) : item;
            });
        }
    }, {
        key: 'getLocalData',
