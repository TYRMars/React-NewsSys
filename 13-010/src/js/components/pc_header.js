...
import {Menu,Icon,Tabs,message,Form} from 'antd';
...
class PCHeader extends React.Component {
  ...
  render(){
    let {getFieldDecorator} = this.props.form; //接收参数
    ...
    <Menu.Item key="register" class="register">
      <Icon type="user" onClick={this.showModal}/>注册／登录
    </Menu.Item>;
    return(
      <header>
        <Row>
          ...
          <Col span={16}>
            ...
            <Modal title="用户中心" visible={this.state.visible} onOk={this.handleOk} onCancel={this.handleCancel}  wrapClassName="vertival-center-model"  okText="关闭">
              <Tabs type="card">
                <TabPane>
